...
# ⏤ { codebase } ⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤
        ...
        try:
            if message.author.bot:
                ...
                if existing_threads:
                    ...
                    await user.send("Your enquiry has been successfully forwarded to the team. Please wait for a reply.")
    ...
    async def close_mail(self, ctx: discord.ComponentInteraction, button):
        ...
        if len(channel_name_parts) == 2:
            ...
            await member.send("This ModMail conversation has just ended. Write again in this chat to open another mail.")
...
def setup(reelab_bot):
    reelab_bot.add_cog(TestFile1(reelab_bot))
